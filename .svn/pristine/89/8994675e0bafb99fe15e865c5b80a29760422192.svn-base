...
class AppValidator extends BraveValidator {
   ...
   function isMemberPriceLegal($field, $vars) {
     ...
     * @return boolean
     */
    function isSchoolStaffNotExisted($field, $vars){
        $phone = $this->data['phone'];
        $id = $this->data['id'];
        ...
        $sql = "SELECT COUNT(id) AS count FROM tb_staff WHERE deleted = 0 AND phone = '{$phone}' AND id <> '{$id}'";
        $rs = $this->getOne($sql);
     ...
     * @return boolean
     */
    function isSchoolTeacherNotExisted($field, $vars){
        $phone = $this->data['phone'];
        $id = $this->data['id'];
        ...
        $sql = "SELECT count(id) AS count FROM tb_school_teacher WHERE deleted = 0 AND phone = '{$phone}' AND id <> '{$id}'";
        $rs = $this->getOne($sql);
     ...
     * @return boolean
     */
    function isSchoolDoctorNotExisted($field, $vars){
        $phone = $this->data['phone'];
        $id = $this->data['id'];
        ...
        $sql = "SELECT count(id) AS count FROM tb_school_doctor WHERE deleted = 0 AND phone = '{$phone}' AND id <> '{$id}'";
        $rs = $this->getOne($sql);
     ...
     * @return boolean
     */
    function isSchoolSupporterNotExisted($field, $vars){
        $phone = $this->data['phone'];
        $id = $this->data['id'];
        ...
        $sql = "SELECT count(id) AS count FROM tb_school_supporter WHERE deleted = 0 AND phone = '{$phone}' AND id <> '{$id}'";
        $rs = $this->getOne($sql);
     ...
     * @return boolean
     */
    function isInOutTime($field, $vars){
        $in_time = $this->data[$field];
        
        if(strtotime($in_time) > strtotime($vars)){
            return true;
        }else{
            return false;
        }
